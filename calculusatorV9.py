...
######################################## Next section of codes retrieves root values from the list as long as roots <=2 
        ...
        if upper > lower:
            if "I" in roots_txt:
                message = " Roots are imaginary. We can treat this as though there are no roots, but plot to confirm. "
                result1_text.insert(END, message)  # Do not remove
                number_roots = 0
            if "*" in roots_txt:
                message= f" There are more than 2 roots. Roots: {roots_txt} Plot and inspect the roots to inform you on how to calculate geometrical area manually. "
